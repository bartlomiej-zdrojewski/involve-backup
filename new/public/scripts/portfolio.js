...
Invity.controller( 'PortfolioController', [ '$scope', '$http', '$window', '$sce', '$mdDialog', '$mdSidenav', '$mdToast', '$mdMedia', 'server', 'navigation', 'tutorial', function ( $scope, $http, $window, $sce, $mdDialog, $mdSidenav, $mdToast, $mdMedia, server, navigation, tutorial ) {
