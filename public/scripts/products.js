...
Involve.controller( 'ProductsController', [ '$scope', '$window', '$http', '$interval', '$sce', '$mdDialog', '$mdToast', 'server', function ( $scope, $window, $http, $interval, $sce, $mdDialog, $mdToast, server ) {
    ...
    $scope.Setup = function ( ) {
        ...
        $http.get( server.url + server.api + "/products" ).then(
            ...
            function ( response ) {
                ...
                if ( response.data.tutorial ) {
                    ...
                    $http.get( server.url + "/tutorials/products.json" ).then(
